...
function paginatorHelper(options = {}) {
  ...
  if (prevNext && current > 1) {
    tags.push(
      htmlTag(
        "a",
        { class: prevClass, rel: "prev", href: link(current - 1) },
        prevText,
        escape
      )
    );
    ...
    tags.push(
      htmlTag("span", { class: prevClass, rel: "prev" }, prevText, escape)
    );
  }
  ...
  if (prevNext && current < total) {
    tags.push(
      htmlTag(
        "a",
        { class: nextClass, rel: "next", href: link(current + 1) },
        nextText,
        escape
      )
    );
    ...
    tags.push(
      htmlTag("span", { class: nextClass, rel: "next" }, nextText, escape)
    );
  }
