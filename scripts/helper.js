 ...
 * @param {number} len - Number of characters to truncate
 * @return {string}
 */
hexo.extend.helper.register(`stripHTML`, function (str, len) {
  return (
    str
      // this line is to remove line indicators generated by prism
      .replace(/</g, " <")
